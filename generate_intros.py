"""Generate NOTED intro/outro audio pieces for all Season 2 series.

Produces:
  season2/intros/noted.mp3               — "NOTED."  (shared, used twice per ep)
  season2/intros/compliant_ep{1-6}.mp3   — "COMPLIANT. Episode one." etc.
  season2/intros/eight_minutes_ep{1-6}.mp3
  season2/intros/null_pointer_ep{1-6}.mp3
  season2/intros/deprecated_ep{1-6}.mp3

All spoken by bm_george (same dry register as NARRATOR).
"""
...
INTROS_DIR = HERE / "season2" / "intros"
